...
cFCOVER<-colorRampPalette(c('beige', 'yellow', 'forestgreen'))(100)
par(mfrow=c(1,2))
...
n0618<-raster("c_gls_NDVI_201807210000_GLOBE_PROBAV_V2.2.1.nc")
n0619<-raster("c_gls_NDVI_201908010000_GLOBE_PROBAV_V2.2.1.nc")
